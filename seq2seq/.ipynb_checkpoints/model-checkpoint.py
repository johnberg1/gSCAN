...
from seq2seq.cnn_model import DownSamplingConvolutionalNet, ResidualConvNet
...
class Model(nn.Module):
    ...
    def __init__(self, input_vocabulary_size: int, embedding_dimension: int, encoder_hidden_size: int,
        ...
        if kwargs["conv_encoder"]:
            ...
            self.situation_encoder = ResidualConvNet(cnn_input_channels, cnn_hidden_num_channels*3)
